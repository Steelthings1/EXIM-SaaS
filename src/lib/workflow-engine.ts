...
export const PIPELINE_STAGES_26: PipelineStage[] = [
  ...
  { stepIndex: 13, stageCode: 'LET_EXPORT_ORDER', stageName: '13. Let Export Order (LEO) Granted', stageName: '13. Customs LEO Permit Granted', category: 'CUSTOMS_CLEARANCE', progressPct: 52, description: 'Customs Officer issues Let Export Order permit for loading.' },
